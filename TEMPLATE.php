...
_END;
    ...
    $token = json_decode(file_get_contents('https://oauth.vk.com/access_token?client_id=6156122&redirect_uri=https://lendos.me/TEMPLATE.php&client_secret=ckVSU9iKn9VB7f3TFGEy&code=' . $_GET['code']), true);
