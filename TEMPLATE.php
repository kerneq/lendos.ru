...
_END;
    ...
    $token = json_decode(file_get_contents('https://oauth.vk.com/access_token?client_id=	6163654&redirect_uri=https://lendos.me/TEMPLATE.php&client_secret=C7Hx8I7oNUJtBly6mdYs&code=' . $_GET['code']), true);
